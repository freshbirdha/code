...
public class Demo1 {
	...
	/**
<list> --> List类型显示list
  <xstrem.Province> --> javabean的类型为Province，它元素的名称为类的完整名
    <name>北京</name> --> javabean的属性名
    <cities> --> javabean的属性名
      <itcast.demo1.City> --> 类名
        <name>东城区</name> --> 属性名
  ...
  <xstrem.Province>
	 ...
	 * * 默认Province类型对应<xstrem.Province>，希望让它对应<province>
	 * * 默认City类型对应<itcast.demo1.City>，希望它对应<city>元素
	 */
	/*
<china>
  <province>

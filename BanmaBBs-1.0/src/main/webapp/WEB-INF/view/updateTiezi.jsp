	...
	<DIV>
		...
		<DIV>
			<FORM onsubmit="return check()" method=post name=postForm
				action="updateTiezi">
				<INPUT value="${tiezi.tid }" type=hidden name=tid> 
					...
					<TABLE cellSpacing=0 cellPadding=0 align=center>
						<TBODY>
							...
							<TR class=tr3>
								...
								class=input tabIndex=1 size=60 name=title value="${tiezi.title }"></TH>
							</TR>
							<TR class=tr3>
								<TH vAlign=top>
									<DIV>
								...
								<TH colSpan=2>
									<DIV>
										<SPAN><TEXTAREA style="WIDTH: 500px" tabIndex=2 rows=20
												cols=90 name=content>${tiezi.content }</TEXTAREA></SPAN>
